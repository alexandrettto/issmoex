...
iss = ISSMOEX()
iss.trades(engine='currency',market='selt',isin='CNYRUB_TOM')
iss.iss_url(url='https://iss.moex.com/iss/engines/currency/markets/selt/securities/CNYRUB_TOM/trades.html',pages=True,records_per_pages=5000)

from issmoex import ISSMOEX
x = ISSMOEX()
x.trades(engine='currency',market='selt',isin='CNYRUB_TOM',show_progress=True)